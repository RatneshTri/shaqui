                ...
                <div id="accordion-flush" data-accordion="collapse"
                    ...
                    <div id="accordion-flush-body-1" class="" aria-labelledby="accordion-flush-heading-1">
                        <div class="py-5 border-b border-gray-200 dark:border-gray-700">
                            <p class="mb-2 text-gray-500 dark:text-gray-400 mx-10">It's a seamless process that allows
                                you to
                                customize white-label products, from apparel to home godds, using your own design. This
                                appraoch minimizes risk and cost, making it ideal for enterpreneurs and creatives who
                                want to focus on design, business, and growth without the logistical challenges og
