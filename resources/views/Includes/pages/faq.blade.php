        ...
        <div class="max-w-screen-2xl mx-auto">
            ...
            <div class="grid md:flex mx-auto">
                ...
                <div class="right w-full md:w-1/2">
                    <div class="max-w-screen-md mx-auto p-0 sm:p-10 dark:bg-gray-800">
                        <div id="accordion-flush" data-accordion="collapse"
                            ...
                            <h3 id="accordion-flush-heading-1">
                                <button type="button"
                                    ...
                                    <span>01 Your ideation your brand, we print</span>
                            ...
                            <div id="accordion-flush-body-1" class="" aria-labelledby="accordion-flush-heading-1">
                                <div class="py-5 border-b border-gray-200 dark:border-gray-700">
                                    <p class="mb-2 text-gray-500 dark:text-gray-400 mx-10">It's a seamless process that
                                        allows
                                        you to
                                        customize white-label products, from apparel to home godds, using your own
                                        design.
                                        This
                                        appraoch minimizes risk and cost, making it ideal for enterpreneurs and
                                        creatives
                                        who
                                        want to focus on design, business, and growth without the logistical challenges
                                        og
                            ...
                            <h3 id="accordion-flush-heading-2">
                                <button type="button"
                                    ...
                                    <span>02 Consistent excellence</span>
                            ...
                            <div id="accordion-flush-body-2" class="hidden" aria-labelledby="accordion-flush-heading-2">
                                <div class="py-5 border-b border-gray-200 dark:border-gray-700">
                                    <p class="mb-2 text-gray-500 dark:text-gray-400 mx-10">#Text.</p>
                            ...
                            <h3 id="accordion-flush-heading-3">
                                <button type="button"
                                    ...
                                    <span>03 Your art, our canvas</span>
                                    <svg data-accordion-icon="" class="w-6 h-6 shrink-0" fill="currentColor"
                                        viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                                        <path fill-rule="evenodd"
                                            d="M5.293 7.293a1 1 0 011.414 0L10 10.586l3.293-3.293a1 1 0 111.414 1.414l-4 4a1 1 0 01-1.414 0l-4-4a1 1 0 010-1.414z"
