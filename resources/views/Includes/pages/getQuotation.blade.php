<div class="m-auto mt-10 w-full">
    ...
    <div class="relative mx-auto sm:mx-10">
        <div class="mySwiper-getQ h-12 md:h-auto mx-2 lg:mx-16">
    ...
    <div class="h-full mx-auto w-full">
        <div
            ...
            <div class="flex flex-col items-start justify-start max-w-screen-2xl mx-auto">
                <h1 class="font-light text-xl sm:text-2xl md:text-4xl lg:text-7xl mb-5">
                    Ready to <br> build together?
                </h1>
                <button
